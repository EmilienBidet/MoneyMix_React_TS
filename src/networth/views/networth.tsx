...
const Networth = () => {
  ...
  const isSignupModal = !isFromFastlink && from === 'accountSettings' && onboarded !== undefined && !onboarded;
                    ...
                    <span className='title'>
                      ...
                      <ul>
                            <li className='inv-data'>
                              ...
                              <span className='measure-amount'>{currencySymbol}{numberWithCommas(fNumber(netWorthSimilar.investmentAssets,0))}</span>
                            </li>
                            <li className='other-data'>
                              <span className='measure-label'>Other Assets</span>
                              <span className='measure-amount'>{currencySymbol}{numberWithCommas(fNumber(netWorthSimilar.otherAssets,0))}</span>

                            </li>
                            <li className='lty-data'>
                              <span className='measure-label'>Liabilities</span>
                              <span className='measure-amount'>{currencySymbol}{numberWithCommas(fNumber(netWorthSimilar.liabilities,0))}</span>

                            </li>
                            <li className='nw-data'>
                              <span className='measure-label'>Net Worth</span>
                              <span className='measure-amount'>{currencySymbol}{numberWithCommas(fNumber(netWorthSimilar.networth,0))}</span>
