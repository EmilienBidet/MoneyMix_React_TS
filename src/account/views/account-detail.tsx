...
const AccountDetail: React.FC = () => {
  ...
  let providerStatus;
  if (AccountDetails?.mmAccountProvider === 'ZABO') {
      providerStatus = 'GOOD';
    } else if (
            ...
            <div className='mm-account'>
                ...
                <div className='d-md-flex justify-content-between mt-3'>
                  <div className='d-flex'>
                    ...
                    <div className='mm-account__selection--type'>
                      {AccountDetails?.syncError && AccountDetails?.mmAccountProvider !== 'ZABO' ? (
              ...
              <div
                className={[
                  ...
                  AccountDetails?.syncError && AccountDetails?.mmAccountProvider !== 'ZABO' ? 'sync-error' : '',
                ].join(' ')}
              >
                {AccountDetails?.syncError && AccountDetails?.mmAccountProvider !== 'ZABO' ? (
              ...
              {AccountDetails?.syncError && AccountDetails?.mmAccountProvider !== 'ZABO' ? null : (
                <>
