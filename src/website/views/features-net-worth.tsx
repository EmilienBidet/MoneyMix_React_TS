...
import NetWorthCompare from 'assets/images/features/net-worth-compare.svg';
    ...
    <WebsiteLayout>
      <HelmetProvider>
        <Helmet>
          ...
          <meta name='description' content='Know your net worth at all times. Compare your net worth to other investors with similar profiles as yours.' />
        </Helmet>
      </HelmetProvider>
...
export const FeaturesNetWorthCompare = () => {
  return (
    <section className='feature-section feature-section-reversed'>
      <div className='row'>
        <div className='col-lg-7 feature-image'>
          <img src={NetWorthCompare} alt='Compare your Net Worth to others' />
        </div>
        <div className='col-lg-5 feature-content'>
          <h2>How you compare</h2>
          <p>
            Compare your net worth to other Money Minx investors with a similar profiles to yours.
          </p>
        </div>
      </div>
    </section>
