...
const Security = () => {
  return (
    <WebsiteLayout>
      <HelmetProvider>
        <Helmet>
         <title>Money Minx Security | Money Minx</title>
          <meta name='description' content='Money Minx takes security very seriously. Here is a few ways on how Money Minx keeps your data secure.' />
        </Helmet>
      </HelmetProvider>
      <SecurityTopSection />
      <SecurityHeroSection />
        ...
        <div className='row security-top'>
          <div className='col-lg-6'>
            ...
            <p className='text text-gap'>
              ...
              up-to-date with best practices, including the following:
            </p>
          </div>
          <div className='col-lg-6'>
          ...
          <div className='col-lg-12'>
            <div className='investment-wrap'>
              ...
              <p className='text'>
                ...
                transactions or any other events with your banks, brokerages and investment sites. In the event that your
              ...
              <p className='text p-b-10'>
                ...
                <a href='mailto:hello@moneyminx.com?subject=Money Minx Security' >
                  Contact us
                </a>
                .
              </p>
