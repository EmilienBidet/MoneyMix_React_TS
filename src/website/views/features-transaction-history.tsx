    ...
    <WebsiteLayout>
      <HelmetProvider>
       <Helmet>
         ...
         <meta name='description' content='Keep an eye on all of your accounts from one place. Use Money Minx as a way to prevent unauthorized transactions by catching them early.' />
       </Helmet>
      </HelmetProvider>
