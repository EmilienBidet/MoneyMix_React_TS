      ...
      <HelmetProvider>
        <Helmet>
         <title>About Net Worth and Investments Tracker | Money Minx</title>
          <meta name='description' content='Money Minx is a net worth calculator and investments tracking tool. Learn more about Money Minx.' />
        </Helmet>
      </HelmetProvider>
        ...
        <div className='col-xl-5'>
          <div className='networth-text'>
            ...
            <p className='text'>
              ...
              banks, crowdfunding sites, financial firms, multiple currencies, crypto wallets and more.
            </p>
          </div>
        </div>
