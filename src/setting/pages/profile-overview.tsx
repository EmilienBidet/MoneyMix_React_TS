                      ...
                      <div className='mm-profile-overview__form'>
                        ...
                        {/*<div className='form-group row align-items-center'>
                          <label htmlFor='username' className='col-md-3 col-form-label'>
                            ...
                            <MMToolTip
                              placement='top'
                              message='Your community username will be synced with this soon. For now they are separate'
                            >
                              <InfoIcon className='mt-n1 ml-2' />
                            </MMToolTip>
                          </label>
              ...
              <div className='card mm-setting-card'>
                <div className='card-body'>
                  <div className='mm-profile-overview__title mm-profile-overview__profile-page'>
                    ...
                    <div className='card-sub-title'>
                      Fill-in the details below to get better comparison results in the Net Worth screen and Asset Allocation screen (coming soon). More investing tips and specialized intelligence coming soon.
                    </div>
                    <div>
                      <div className='mm-profile-overview__form'>
                        <div className='form-group row align-items-center'>
